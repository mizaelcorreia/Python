...
class Calculadora(object):
    def __init__(self, instancia): # Metodo construtor
        #Colocar a entrada de texto
        self.form = Entry(instancia)
        self.form.pack()

        #Botão calcular
        self.calc = Button(instancia, text = "Calcule", command = self.Calcular) # Chama o metodo Calcular quando clica no botao Calcule
        self.calc.pack()
        ...
        #Cria os botos usando os elementos da tupla botões
        for b in botões:
